...
class Config:
    ...
    # These values must be set via your local root '.env' file or your Render Dashboard.
    
    # Absolute file path to your Stockfish executable binary
    STOCKFISH_PATH: str = os.environ.get("STOCKFISH_PATH", "")
    
    # Secure API token generated from your Lichess account dashboard
