...
* **[gm2001.bin](https://github.com/michaeldv/donna_opening_books):** A highly optimized, classic polyglot opening book file used to diversify the bot's early-game move selections.
* **[lichess-bot-devs](https://github.com/lichess-bot-devs/lichess-bot):** The official bridge reference code that teaches independent developers how to stream games and post moves using the Lichess API.

## 🌍 Contributors & Community
* **Founded and Maintained by:** Aarav Patel ([@GoogleHub67](https://github.com/GoogleHub67))
* A special thank you to all open-source maintainers whose documentation and repositories made this project possible.
